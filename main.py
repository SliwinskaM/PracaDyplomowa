...
# apriori2 = ard.AssociationRules(conv_r_matrix, 20, curves.Names, min_support=0.00001, min_confidence=0.4)
...
recomm_score = recomm.test_recommend(t_matrix, 20, curves.Names, test_size=0.3, min_support=0.0000001, min_confidence=0.4)
pass
