...
class Curves1(FuzzyCurves):
    ...
    def low_curve(self, score):
        if 0 <= self.thr1 < self.thr2 <= self.thr3 < self.thr4 <= 1:
            ...
            if self.thr1 < score_norm < self.thr2:
                return 1 - (1 / (self.thr2 - self.thr1)) * (score_norm - self.thr1) # round(1 - (1 / (self.thr2 - self.thr1)) * (score_norm - self.thr1), 2)
        return 0
    ...
    def medium_curve(self, score):
        if 0 <= self.thr1 < self.thr2 <= self.thr3 < self.thr4 <= 1:
            ...
            if self.thr3 < score_norm < self.thr4:
                return 1 - (1 / (self.thr4 - self.thr3)) * (score_norm - self.thr3)# round(1 - (1 / (self.thr4 - self.thr3)) * (score_norm - self.thr3), 2)
        return 0
    ...
    def high_curve(self, score):
        if 0 <= self.thr1 < self.thr2 <= self.thr3 < self.thr4 <= 1:
            ...
            score_norm = (score - self.min_score) / (self.max_score - self.min_score)
            if self.thr3 < score_norm < self.thr4:
                return (1 / (self.thr4 - self.thr3)) * (score_norm - self.thr3) # round((1 / (self.thr4 - self.thr3)) * (score_norm - self.thr3), 2)
...
class Curves2(FuzzyCurves):
    ...
    def high_curve(self, score):
        if 0 <= self.thr1 < self.thr2 <= 1:
            ...
            score_norm = (score - self.min_score) / (self.max_score - self.min_score)
            if self.thr1 < score_norm < self.thr2:
                return (1 / (self.thr2 - self.thr1)) * (score_norm - self.thr1) # round((1 / (self.thr2 - self.thr1)) * (score_norm - self.thr1), 2)
            if score_norm >= self.thr1:
                return 1
        return 0
